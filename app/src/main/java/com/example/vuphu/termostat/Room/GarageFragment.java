...
public class GarageFragment extends Fragment {
    ...
    private SharedPreferences garage;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        garage = getActivity().getSharedPreferences("garage",MODE_PRIVATE);
        edt = garage.edit();
        tv_temp =  v.findViewById(R.id.tv_temp_garage);
        tv_day = v.findViewById(R.id.tv_day_garage);
        tv_night = v.findViewById(R.id.tv_night_garage);
        ...
        tv_day.setText(garage.getInt("temp_day",0)+"°C");
        tv_night.setText(garage.getInt("temp_night",0)+"°C");
        croller = (Croller) v.findViewById(R.id.croller_garage);
        ...
        day = v.findViewById(R.id.day_garage);
        night = v.findViewById(R.id.night_garage);
        ...
        power = v.findViewById(R.id.power_garage);
        cool = v.findViewById(R.id.cool_garage);
        auto= v.findViewById(R.id.auto_garage);
        away = v.findViewById(R.id.away_garage);

        state_power();
        function();

        ripple = v.findViewById(R.id.ripplegr);
        apply = v.findViewById(R.id.start_garage);
        apply.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(ripple.isRippleAnimationRunning()){
                    ...
                    {
                        tv_temp.setText(garage.getInt("temp_day",0)+"°C");
                        croller.setProgress(garage.getInt("temp_day",0));

                    }
                    else
                    {
                        tv_temp.setText(garage.getInt("temp_night",0)+"°C");
                        croller.setProgress(garage.getInt("temp_night",0));
                    }
...
//            Toast.makeText(getContext(), "You are at "+getArguments().getString("place").replace("_"," "), Toast.LENGTH_SHORT).show();
    ...
    public static GarageFragment newInstance(String place, int temp, boolean power, boolean cool, boolean auto, boolean away) {
