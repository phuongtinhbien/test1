...
public class LivingRoomFragment extends Fragment {
    ...
    private SharedPreferences living_room;
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container,
        ...
        living_room = getActivity().getSharedPreferences(getArguments().getString("place"),MODE_PRIVATE);
        edt = living_room.edit();
        tv_temp =  v.findViewById(R.id.tv_temp_living_room);
        tv_day = v.findViewById(R.id.tv_day_living_room);

        tv_night = v.findViewById(R.id.tv_night_living_room);
        ...
        tv_day.setText(living_room.getInt("temp_day",0)+"°C");
        tv_night.setText(living_room.getInt("temp_night",0)+"°C");

        ripple = v.findViewById(R.id.ripplelv);
        apply = v.findViewById(R.id.start_living_room);



        croller = (Croller) v.findViewById(R.id.croller_living_room);
        ...
        apply.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(ripple.isRippleAnimationRunning()){
                    ...
                    {
                        tv_temp.setText(living_room.getInt("temp_day",0)+"°C");
                        croller.setProgress(living_room.getInt("temp_day",0));

                    }
                    else
                    {
                        tv_temp.setText(living_room.getInt("temp_night",0)+"°C");
                        croller.setProgress(living_room.getInt("temp_night",0));
                    }
        ...
        power = v.findViewById(R.id.power_living_room);
        cool = v.findViewById(R.id.cool_living_room);
        auto= v.findViewById(R.id.auto_living_room);
        away = v.findViewById(R.id.away_living_room);

        day = v.findViewById(R.id.day_living_room);
        night = v.findViewById(R.id.night_living_room);
        state_power();
        function();
...
//            Toast.makeText(getContext(), "You are at "+getArguments().getString("place").replace("_"," "), Toast.LENGTH_SHORT).show();
    ...
    public static LivingRoomFragment newInstance( String place,int temp, Boolean power, Boolean cool, Boolean auto, Boolean away) {
