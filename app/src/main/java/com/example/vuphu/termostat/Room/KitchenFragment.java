...
public class KitchenFragment extends Fragment {
    ...
    private SharedPreferences kitchen;
    ...
    public static KitchenFragment newInstance(String place, int temp, boolean power, boolean cool, boolean auto, boolean away) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        kitchen = getActivity().getSharedPreferences("kitchen",MODE_PRIVATE);
        edt = kitchen.edit();
        tv_temp =  v.findViewById(R.id.tv_temp_kitchen);
        tv_day = v.findViewById(R.id.tv_day_kitchen);
        tv_night = v.findViewById(R.id.tv_night_kitchen);
        ...
        tv_day.setText(kitchen.getInt("temp_day",0)+"°C");
        tv_night.setText(kitchen.getInt("temp_night",0)+"°C");

        croller = (Croller) v.findViewById(R.id.croller_kitchen);
        ...
        power = v.findViewById(R.id.power_kitchen);
        cool = v.findViewById(R.id.cool_kitchen);
        auto= v.findViewById(R.id.auto_kitchen);
        away = v.findViewById(R.id.away_kitchen);

        day = v.findViewById(R.id.day_kitchen);
        night = v.findViewById(R.id.night_kitchen);
        state_power();
        function();

        ripple = v.findViewById(R.id.ripplekt);
        apply = v.findViewById(R.id.start_kitchen);
        apply.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(ripple.isRippleAnimationRunning()){
                    ...
                    {
                        tv_temp.setText(kitchen.getInt("temp_day",0)+"°C");
                        croller.setProgress(kitchen.getInt("temp_day",0));

                    }
                    else
                    {
                        tv_temp.setText(kitchen.getInt("temp_night",0)+"°C");
                        croller.setProgress(kitchen.getInt("temp_night",0));
                    }
